            ...
            if (chart1 != null && chart1.Series.Count >= 3)
            {
                ...
                if (monthlyData.Count > 0)
                {
                    ...
                    foreach (var month in sortedMonths)
                    {
                        ...
                        chart1.Series[0].Points.AddXY(monthName, (double)month.Value.paid);
                        chart1.Series[1].Points.AddXY(monthName, (double)month.Value.unpaid);
                        chart1.Series[2].Points.AddXY(monthName, (double)month.Value.partiallyPaid);
                    }
                }
            }
